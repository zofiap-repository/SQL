...
SELECT 
    ...
    CASE
        ...
        WHEN population BETWEEN 1000000 AND 10000000 THEN 'between 1 and 10 million'
        WHEN population < 1000000 THEN 'below 1 million'
...
--Which 10 countries have the fastest-growing populations this year?
SELECT 
    name AS fastest_growing_populations,
